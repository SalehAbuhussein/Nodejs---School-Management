import StudentTier, { IStudentTier } from 'src/db/models/studentTier.model';
 ...
 */
export const getAllStudentTiers = async (): Promise<IStudentTier[]> => {
  try {
 ...
 */
export const createStudentTier = async (studentTier: IStudentTier): Promise<IStudentTier> => {
  try {
 ...
 * @throws {CustomError} If database operation fails
 */
export const checkStudentTierExists = async (studentTierId: string): Promise<boolean> => {
  try {
